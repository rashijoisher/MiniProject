...
def main():
    ...
    plot_confusion_matrix(results['val_cm'], 'Validation Set Confusion Matrix', labels)
    plot_confusion_matrix(results['test_cm'], 'Test Set Confusion Matrix', labels)
    
    print("\nPlots saved as 'validation_set_confusion_matrix.png' and 'test_set_confusion_matrix.png'")
